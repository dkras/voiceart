 ...
 *  
 */
webpackJsonpVoiceArt__name_([8,3],{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPTION_CLASS = _strings2.default.selectors.NAMESPACE + '-' + _strings2.default.selectors.OPTION;

	var CommonDropdownAdapter = function (_AbstractFieldAdapter) {
	    _inherits(CommonDropdownAdapter, _AbstractFieldAdapter);

	    function CommonDropdownAdapter() {
	        _classCallCheck(this, CommonDropdownAdapter);

	        return _possibleConstructorReturn(this, (CommonDropdownAdapter.__proto__ || Object.getPrototypeOf(CommonDropdownAdapter)).apply(this, arguments));
	    }

	    _createClass(CommonDropdownAdapter, [{
	        key: '_initHook',


	        /** @inheritdoc */
	        value: function _initHook() {
	            _get(CommonDropdownAdapter.prototype.__proto__ || Object.getPrototypeOf(CommonDropdownAdapter.prototype), '_initHook', this).call(this);
	        ...
	        value: function buildModel() {
	            ...
	            for (var i = 0; i < oElements.length; i++) {
	                ...
	                var option = {
	                    display: _controllerUtils2.default.getElementDisplayText(oElement, OPTION_CLASS),
	                    value: oElement.value
	                };
	                option.speech = _controllerUtils2.default.getElementSpeech(oElement) || option.display;
	    ...
	    return CommonDropdownAdapter;
	}(_abstractFieldAdapter2.default);

	exports.default = CommonDropdownAdapter;
	;
	module.exports = exports['default'];
