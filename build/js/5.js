 ...
 *  
 */
webpackJsonpVoiceArt__name_([5,3,17],{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CgEssayAdapter = function (_TextEntryAdapter) {
	  _inherits(CgEssayAdapter, _TextEntryAdapter);

	  function CgEssayAdapter() {
	    _classCallCheck(this, CgEssayAdapter);

	    return _possibleConstructorReturn(this, (CgEssayAdapter.__proto__ || Object.getPrototypeOf(CgEssayAdapter)).apply(this, arguments));
	  }

	  _createClass(CgEssayAdapter, [{
	  ...
	  return CgEssayAdapter;
	}(_textEntryAdapter2.default);

	exports.default = CgEssayAdapter;
	;
	module.exports = exports['default'];
