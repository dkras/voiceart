 ...
 *  
 */
webpackJsonpVoiceArt__name_([7,3],{
	...
	var CgMcAdapter = function (_AbstractFieldAdapter) {
	    ...
	    _createClass(CgMcAdapter, [{
	        ...
	        value: function buildModel() {
	            ...
	            var model = {
	                subtype: domElement.getAttribute('widget-subtype'),
	                choices: []
	            };
	            ...
	            for (var i = 0; i < cElements.length; i++) {
	                ...
	                var labelElement = cElement.querySelector('label');
	                var inputElement = cElement.querySelector('input');
	                var choice = {
