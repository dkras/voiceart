 ...
 *  
 */
webpackJsonpVoiceArt__name_([9,3,17],{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommonEssayAdapter = function (_TextEntryAdapter) {
	  _inherits(CommonEssayAdapter, _TextEntryAdapter);

	  function CommonEssayAdapter() {
	    _classCallCheck(this, CommonEssayAdapter);

	    return _possibleConstructorReturn(this, (CommonEssayAdapter.__proto__ || Object.getPrototypeOf(CommonEssayAdapter)).apply(this, arguments));
	  }

	  _createClass(CommonEssayAdapter, [{
	    key: '_getFieldSelector',
	    value: function _getFieldSelector() {
	      return 'textarea';
	    }
	  ...
	  return CommonEssayAdapter;
	}(_textEntryAdapter2.default);

	exports.default = CommonEssayAdapter;
	;
	module.exports = exports['default'];
