 ...
 *  
 */
webpackJsonpVoiceArt__name_([4,3],{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPTION_SELECTOR = 'select option[value]';

	var CgDropdownAdapter = function (_AbstractFieldAdapter) {
	    _inherits(CgDropdownAdapter, _AbstractFieldAdapter);

	    function CgDropdownAdapter() {
	        _classCallCheck(this, CgDropdownAdapter);

	        return _possibleConstructorReturn(this, (CgDropdownAdapter.__proto__ || Object.getPrototypeOf(CgDropdownAdapter)).apply(this, arguments));
	    }

	    _createClass(CgDropdownAdapter, [{
	        key: '_initHook',


	        /** @inheritdoc */
	        value: function _initHook() {
	            _get(CgDropdownAdapter.prototype.__proto__ || Object.getPrototypeOf(CgDropdownAdapter.prototype), '_initHook', this).call(this);
	        ...
	        value: function buildModel() {
	            ...
	            var oElements = domElement.querySelectorAll(OPTION_SELECTOR);
	            for (var i = 0; i < oElements.length; i++) {
	                var oElement = oElements[i];
	                var option = {
	                    display: oElement.textContent,
	    ...
	    return CgDropdownAdapter;
	}(_abstractFieldAdapter2.default);

	exports.default = CgDropdownAdapter;
	;
	module.exports = exports['default'];
